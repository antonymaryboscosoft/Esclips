...
//	
	...
	WebElement el = wait.until(ExpectedConditions.elementToBeClickable(By.id("com.ozeri.babyscale:id/chk_agree")));
	el.click();
	Thread.sleep(3000);
    JavascriptExecutor js = (JavascriptExecutor) driver;
    while(((List<AndroidElement>) driver.findElementById("com.ozeri.babyscale:id/chk_agree")).size()==0)
    {
