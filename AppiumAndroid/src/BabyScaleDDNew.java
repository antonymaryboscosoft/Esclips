...
//1.Add  8 babies
		...
		Thread.sleep(1000);
			...
			for(int rowCount1=2; rowCount1<=9; rowCount1++){
				...
				driver.findElementById("com.ozeri.babyscale:id/img_back").click();
				Thread.sleep(1000);
				if(rowCount1==2){
				driver.findElementByXPath("//android:id/button1[ @text='YES']").click();
				Thread.sleep(1000);
				}
				driver.findElementByXPath("//android:id/button1[ @text='NO']").click();
				Thread.sleep(1000);*/
				...
				Thread.sleep(1000);
					...
					String Date= reader.getCellData("Addbabies", "date",rowCount1 );
					System.out.println(Date);
					driver.findElementByXPath("//android.view.View[ @index='"+rowCount1+"']").sendKeys(Date);
					Thread.sleep(1000);
...
//2.Add Measurement
	...
	//Print the reading in console
			...
			for (int j=8; j<=rowNum; j++){
				...
				driver.findElementByXPath("//android.view.View[ @index='"+rowCount+"']");
				Thread.sleep(1000);
				driver.findElement(By.id("android:id/button1")).click();
				Thread.sleep(1000);
			...
			//Enter weight
				...
				//without enter Weight reading throw error msg.
